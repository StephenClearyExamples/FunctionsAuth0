...
> Note: This simple SPA is not validating the tokens. It just assumes that the user is logged in when those tokens are present. A SPA should validate the tokens before considering the user "logged in".
